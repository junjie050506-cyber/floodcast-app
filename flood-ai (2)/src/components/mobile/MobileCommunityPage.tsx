                      ...
                      <div className="relative">
                        <div className="flex border-b border-zinc-200 dark:border-white/10">
                          <button
                            ...
                            className={`flex-1 py-2.5 text-center font-bold text-xs uppercase tracking-widest relative transition-all ${
                                ...
                                >
                                  ...
                                  <div className="flex items-center space-x-6 pt-2 border-t border-gray-500/5 text-gray-400 font-mono select-none">
                                    <button
                                      ...
                                      className={`flex items-center space-x-1.5 text-[9px] font-black uppercase transition-all duration-300 ${
                                        upvotedPostIds.includes(post.id) ? 'text-[#FF453A]' : ''
                                      }`}
                                    >
                                      <Heart
                                        size={13}
                          ...
                          <div className="border-b border-zinc-200 dark:border-white/10 flex space-x-2 overflow-x-auto no-scrollbar select-none py-1">
                            {['about', 'feed'].map((tab) => (
                              <button
                                ...
                                className={`py-1.5 px-3.5 rounded-full font-bold text-[10px] uppercase tracking-wider transition-all whitespace-nowrap ${
                                ...
                                activeTabPosts.map((post: any) => (
                                  ...
                                  >
                                    ...
                                    <div className="flex items-center space-x-6 pt-2 border-t border-gray-500/5 text-gray-400 font-mono select-none">
                                      <button
                                        onClick={() => handleToggleUpvote(post.id)}
                                        className={`flex items-center space-x-1.5 text-[9px] font-black uppercase transition-colors ${
                                          upvotedPostIds.includes(post.id) ? 'text-[#FF453A]' : ''
                                        }`}
                                      >
                                        <Heart
